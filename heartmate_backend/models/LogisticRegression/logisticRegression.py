...
for train_index, test_index in cv.split(X, y):
    ...
    classifier = LogisticRegression(solver='lbfgs', max_iter=20000)
    ...
    if accuracy > best_acc:
        ...
        bestModel_data["prediction"] = logistic_prediction
    ...
    # Else # If the accuracy of the trained model is less than the current lowest accuracy
        ...
        worstModel_data["prediction"] = logistic_prediction
...
with open('LogR.pickle', 'wb') as handle:
